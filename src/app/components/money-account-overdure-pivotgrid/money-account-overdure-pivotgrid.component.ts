...
@Component({
    selector: 'app-money-account-overdure-pivotgrid',
    templateUrl: './money-account-overdure-pivotgrid.component.html',
    styleUrls: ['./money-account-overdure-pivotgrid.component.css']
})
export class MoneyAccountOverdurePivotgridComponent implements OnInit {
