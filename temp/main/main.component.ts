...
import {DxListComponent, DxChartComponent} from 'devextreme-angular';
...
export class MainComponent implements OnInit {
    ...
    @ViewChild(DxChartComponent) finInstance: DxChartComponent;
        ...
        load: function (loadOptions: any) {
            ...
            return RestClientService.get('GetFinancialCycle', chartFinData)
                .done(function (result: any) {
                    ...
                    /*this.finInstance.instance.option("valueAxis", [{
                        name: 'Value',
                        position:'left',
                        tickInterval: 10,
                        format: 'decimal',
